...
if [[ "$publish_confirm" =~ ^[Yy]$ ]]; then
    ...
    if npm publish; then
        ...
        echo ""
        echo "View your package at: https://www.npmjs.com/package/aimap"
        echo ""
        echo "Install globally: npm install -g aimap"
        echo "Or use with npx: npx aimap build"
    else
...
echo "- Create a GitHub release at: https://github.com/nacyot/aimap/releases/new"
echo "- Test the published package: npx aimap@$NEW_VERSION --help"
echo ""
